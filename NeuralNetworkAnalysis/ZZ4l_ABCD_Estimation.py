...
if __name__ == "__main__":
    ...
    for mass in mass_array:
        ...
        for region_name in Region_Array:
            ...
            for sample_name in ZZ4l_dict["ZZ4l"]:
            ...
            for sample in ZZ4l_dict["ZZ4l"]:
                background_input_dict[sample] = background_input_dict[sample][background_input_dict[sample].numBJet < 1] #No bJets
            ...
            if (region_name == "B"):
                ...
                weight_sum = 0 
                for sample in ZZ4l_dict["ZZ4l"]:
                    background_input_dict[sample] = background_input_dict[sample][background_input_dict[sample].ZMult >= 1] #Z Multiplicity
                ...
                plt.savefig("ZZ4l_region_" + region_name + "_Mass_" +mass)
                plt.close()
            ...
            if (region_name == "C"):
                ...
                weight_sum = 0 
                for sample in ZZ4l_dict["ZZ4l"]:
                    background_input_dict[sample] = background_input_dict[sample][background_input_dict[sample].ZMult < 1] #0 Z Multiplicity
            ...
            if (region_name == "A"):
                ...
                NA_error = NA_real_error*(weight_sum/NA_real)
                hep.histplot(four_tau_hist)
                ...
                plt.savefig("ZZ4l_region_" + region_name + "_Mass_" +mass)
                plt.close()
                #print("There are %f ZZ4l in high purity region (sans ABCD)"% four_tau_hist.sum())
        ...
        print("ZZ4l background estimate for " + mass + " mass point: %.3f pm %.3f"%(Est_Dict[mass],Unct))
        #print("ZZ4l background estimate for " + mass + " mass point: %f"%Est_Dict[mass])
