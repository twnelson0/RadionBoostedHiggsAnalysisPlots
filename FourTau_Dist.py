...
#def reco_Higgs(part1, part2):
	#higgs = ak.zip(
	#	{
	#		"trigger": part1.trigger
	#	}
	#)
...
xSection_Dictionary = {"Signal": 500, #Chosen to make plots readable 
						#TTBar Background
						"TTTo2L2Nu": 0.1061*831.76, "TTToSemiLeptonic": 0.4392*831.76, "TTToHadronic": 0.4544*831.76,
						#DiBoson Background
						"ZZ4l": 1.212, "ZZ2l2q": 3.22, "WZ3l1nu": 4.708, "WZ2l2q": 5.595, "WZ1l1nu2q": 10.71, "VV2l2nu": 11.95, "WZ3l1nu.root" : 4.708,
						#DiBoson continued
						...
						"WJetsToLNu_HT-100To200.root" : 1345*WScaleFactor, "WJetsToLNu_HT-200To400": 359.7*WScaleFactor, "WJetsToLNu_HT-400To600": 48.91*WScaleFactor, "WJetsToLNu_HT-600To800": 12.05*WScaleFactor, "WJetsToLNu_HT-800To1200": 5.501*WScaleFactor, "WJetsToLNu_HT-1200To2500" : 1.329*WScaleFactor, "WJetsToLNu_HT-2500ToInf" : 0.03216*WScaleFactor, 
						#ZH 
...
if __name__ == "__main__":
	...
	trigger_dict = {"No_Trigger": (42,True)}
	#trigger_dict = {"PFHT500_PFMET100_PFMHT100_IDTight": (39,False), "AK8PFJet400_TrimMass30": (40,False), "EitherOr_Trigger": (41,True)}
	...
	for mass in mass_str_arr:
		...
		file_dict = {
			"TTToSemiLeptonic": [background_base + "TTToSemiLeptonic.root"], "TTTo2L2Nu": [background_base + "TTTo2L2Nu.root"], "TTToHadronic": [background_base + "TTToHadronic.root"],
			"ZZ4l": [background_base + "ZZ4l.root"], "WZ3l1nu" : [background_base + "WZ3l1nu.root"], "WZ2l2q" : [background_base + "WZ2l2q.root"], "WZ1l1nu2q" : [background_base + "WZ1l1nu2q.root"],
			"VV2l2nu" : [background_base + "VV2l2nu.root"], #"ZZTo2L2Nu_powheg": [backgroung_base + "ZZTo2L2Nu_powheg.root"], "" : [background_base + ".root"], : [background_base + ".root"]
			"WZ3l1nu" : [background_base + "WZ3l1nu.root"], "ZZ2l2q" : [background_base + "ZZ2l2q.root"], 
			...
			"QCD_HT300to500" : [background_base + "QCD_HT300to500.root"],"QCD_HT500to700" : [background_base + "QCD_HT500to700.root"],"QCD_HT700to1000" : [background_base + "QCD_HT700to1000.root"],
			"QCD_HT1000to1500" : [background_base + "QCD_HT1000to1500.root"],"QCD_HT1500to2000" : [background_base + "QCD_HT1500to2000.root"],"QCD_HT2000toInf" : [background_base + "QCD_HT2000toInf.root"],
			"Signal": [signal_base + mass + ".root"]	
		}
		hist_dict = {
			"FourTau_Mass_Arr": hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Regular(40,0,3000, label = r"$m_{4\tau}$ [GeV]").Double(),
			"HiggsDeltaPhi_Arr": hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Reg(40,-pi,pi, label = r"Higgs $\Delta \phi$").Double(), 
			"Higgs_DeltaR_Arr": hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Reg(40,0,5, label = r"Higgs $\Delta$R").Double(),
			"leading_dR_Arr": hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Reg(40,0,5, label = r"Leading di-$\tau$ $\Delta$R").Double(),
			"subleading_dR_Arr": hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Reg(40,0,5, label = r"Sub-leading di-$\tau$ $\Delta$R").Double(),
			"LeadingHiggs_mass" : hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Reg(40,0,120, label=r"Leading Higgs Mass (GeV)").Double(),
			"SubLeadingHiggs_mass" : hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Reg(40,0,120, label=r"Sub-Leading Higgs Mass (GeV)").Double(),
			"radionPT_Arr" : hist.Hist.new.StrCat([r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", "ZZ4l", "Signal"]).Reg(40,0,500, label=r"Radion $p_T$ (GeV)").Double()
		}
		...
		#background_list = ["TTToSemiLeptonic","TTTo2L2Nu","TTToHadronic","ZZ4l","DYJetsToLL_Pt-50To100","DYJetsToLL_Pt-100To250","DYJetsToLL_Pt-250To400","DYJetsToLL_Pt-400To650","DYJetsToLL_Pt-650ToInf","WZ3l1nu","WZ2l2q","WZ1l1nu2q"]
		background_list = [r"$t\bar{t}$", r"Drell-Yan+Jets", "Di-Bosons", "Single Top", "QCD", "W+Jets", r"$ZZ \rightarrow 4l$"]
		background_dict = {r"$t\bar{t}$" : ["TTToSemiLeptonic","TTTo2L2Nu","TTToHadronic"], 
					...
					"Di-Bosons": ["WZ3l1nu","WZ2l2q","WZ1l1nu2q","ZZ2l2q","WZ3l1nu", "VV2l2nu"], "Single Top": ["Tbar-tchan","T-tchan","Tbar-tW","T-tW"],
				...
				if (hist_name != "Pair_DeltaPhi_Hist" and hist_name != "RadionPTComp_Hist"):
					for background_type in background_list:
						...
						for background in backgrounds:
							tempArray = np.append(tempArray,ak.to_numpy(fourtau_out[background][hist_name]))
						for background in backgrounds:
							if (len(tempArray) != 0):
								hist_dict[hist_name].fill(background_type,fourtau_out[background][hist_name],weight=fourtau_out[background]["Weight"]*1/(len(tempArray)))
							else:
