...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL16MiniAODv2/RadionTohhTohtatahbb_narrow_M-4000_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v1/270000/14D5DA94-226B-2E43-B9E6-2AF68BA7BE62.root'),
...
#Added by Ganesh
#from bbtautauAnalysisScripts.particleNetForFatJettoTaus.particleNetForFatJettoTaus_cfi import pfParticleNetAK8LastJetTagInfos
#process = pfParticleNetAK8LastJetTagInfos

# Automatic addition of the customisation function from PhysicsTools.NanoAOD.nano_cff
from PhysicsTools.NanoAOD.nano_cff import nanoAOD_customizeMC 
#from PhysicsTools.NanoAOD.newParticleNetForAK8_Customize import customize_pnet

#call to customisation function nanoAOD_customizeMC imported from PhysicsTools.NanoAOD.nano_cff
process = nanoAOD_customizeMC(process)
#process = customize_pnet(process)
